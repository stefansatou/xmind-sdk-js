...
for (const key in marker) {
    ...
    for (const markerId in map) {
        if (!map.hasOwnProperty(markerId))
            continue;
        ...
        if (!exports.icons[collection]) {
            exports.icons[collection] = {};
        }
        iterable[collection].push(name);
        exports.icons[collection][name] = { groupId: realGroupId, markerId: markerId };
    }
}
Object.defineProperty(exports.icons, 'iterable', {
    value: iterable,
    enumerable: false,
    configurable: false,
    writable: false
});
module.exports = exports = exports.icons;
